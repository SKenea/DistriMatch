...
export const DISTRIBUTOR_TYPES = [
    ...
    { id: 'meals', emoji: '🍽️', name: 'Plats cuisinés' },
...
export const GREETING_MESSAGES = {
    morning: ["Bonjour ! Envie d'un petit-dejeuner ?", "Hello ! Je suis ouvert, passe me voir !", "Bien dormi ? Un café et une viennoiserie ?", "Salut ! Commence bien ta journee avec moi !"],
...
export const ALERT_MESSAGES = {
    ...
    price_drop: ["Offre speciale sur {product} ! Profites-en vite.", "Bon plan : {product} a découvrir.", "{product} : c'est le moment !"],
    new_product: ["Nouveau ! Découvre {product}", "J'ai une nouveaute pour toi : {product}", "Exclusivite : {product} vient d'arriver !"]
};
...
export const EMBEDDED_DATA = {
    distributors: [
        ...
        { id: "dist-005", name: "Plats Cuisinés Bayonne", type: "meals", emoji: "🍽️", address: "15 Rue Port-Neuf, 64100 Bayonne", city: "Bayonne", lat: 43.4929, lng: -1.4748, rating: 4.3, reviewCount: 78, status: "verified", priceRange: "€€", products: [{ name: "Axoa de veau", price: 9.50, available: true }, { name: "Poulet basquaise", price: 8.50, available: true }] },
        ...
        { id: "dist-007", name: "Légumes Bio Cambo", type: "agricultural", emoji: "🥕", address: "Route des Thermes, 64250 Cambo-les-Bains", city: "Cambo-les-Bains", lat: 43.3592, lng: -1.4003, rating: 4.7, reviewCount: 91, status: "verified", priceRange: "€€", products: [{ name: "Panier légumes saison", price: 12.00, available: true }, { name: "Pommes de terre", price: 4.50, available: true }] },
        ...
        { id: "dist-011", name: "Pizza Guethary Plage", type: "pizza", emoji: "🍕", address: "Avenue du Général de Gaulle, 64210 Guethary", city: "Guethary", lat: 43.4242, lng: -1.6097, rating: 4.4, reviewCount: 98, status: "verified", priceRange: "€€", products: [{ name: "Pizza Royale", price: 11.00, available: true }, { name: "Pizza Surfeur", price: 12.00, available: true }] },
    ...
    typeConfig: {
        pizza: { label: "Pizza fraîche", gradient: "linear-gradient(135deg, #ff6b6b 0%, #feca57 100%)" },
        bakery: { label: "Boulangerie & Taloa", gradient: "linear-gradient(135deg, #cd853f 0%, #daa520 100%)" },
        fries: { label: "Frites fraîches", gradient: "linear-gradient(135deg, #f9ca24 0%, #f0932b 100%)" },
        meals: { label: "Plats cuisinés", gradient: "linear-gradient(135deg, #6c5ce7 0%, #a29bfe 100%)" },
